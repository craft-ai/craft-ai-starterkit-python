...
- Create a new project using this [link](https://beta.craft.ai/inspector). You can see that you have now two tokens : the "Read API token" and the "Write API token". Only the latter will be used here. These tokens allow you to authenticate your calls to the **craft ai** API as explain in the subsection 1 of this [tutorial](https://beta.craft.ai/doc/python).
